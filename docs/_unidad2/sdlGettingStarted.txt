...
Actividad 13: solución-video 20
--------------------------------

Esta es la solución que propone el autor al video 19. 
Es la misma solución presentada en el video 20.
...
Actividad 14: cargando una fuente
-----------------------------------

Debes instalar la biblioteca SDL_ttf y descargar la fuente 
correspondiente.
...
.. code-block:: C
  ...
  int main(int argc, char* argv[]) {
      ...
      // Cargar fuente
      TTF_Font* fuente = TTF_OpenFont("Pixelmania.ttf", 16); // Asegúrate de tener esta fuente o cambia la ruta
      if (!fuente) {
